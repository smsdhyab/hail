...
const CASHIER: Section[] = [
  {
    q: "تسجيل الدخول واختيار الكاشير",
    steps: [
      "افتح اختصار «كاشير هيل» على الجهاز.",
      "اختر الكاشير الذي تعمل عليه: 🥐 المعجنات والمخبوزات أو ☕ الكافيه.",
      "أدخل اسم المستخدم وكلمة المرور الخاصين بك.",
      "حسابك مرتبط بكاشير واحد فقط — لو اخترت الكاشير الآخر سيرفض الدخول. المدير يدخل الاثنين.",
    ],
  },
  {
    q: "الطلب المشترك بين القسمين",
    steps: [
      "لو طلب الزبون بقلاوة وكيك وكافيه، ينقسم الطلب تلقائياً: المعجنات لكاشير المعجنات والكافيه لكاشير الكافيه — برقم طلب واحد يراه الزبون.",
      "كل شاشة تعرض أصنافها فقط، مع شريط «🔗 طلب مشترك» يوضّح المبلغ الكامل المطلوب من الزبون.",
      "الزبون يدفع مرة واحدة عند أي كاشير، والنظام يوزّع المبلغ على حساب كل قسم حسب أصنافه.",
      "لوحة التحكم تعرض مبيعات قسمك فقط؛ المدير يرى القسمين معاً.",
    ],
  },
  {
...
const ADMIN: Section[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "يظهر تطبيق «إدارة هيل» يفتح مباشرة على لوحة التحكم.",
    ],
  },
];
